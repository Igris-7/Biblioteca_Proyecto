                        ...
                        <form name="form-prestamo" method="post" action="procesa_prestamo">
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                  <label>Codigo:</label>
                                  <input type="text" class="form-control" value="<%=CodPrestamo%>" name="CodPrestamo" readonly>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-10 mb-3">
                                  ...
                                  <input type="text" class="form-control" value="<%=NomMate_biblio%>"  readonly>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label>Editorial:</label>
                                  <input type="date" class="form-control" value="<%=FpPrestamo%>" name='FpPrestamo'  readonly>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label>Fecha de Publicacion:</label>
                                  <input type="date" class="form-control" value="<%=FePrestamo%>" name='FePrestamo' readonly>
                                </div>
                            </div><br>
                            <input type="submit" name="eliminar_prestamo" value="Ingresar"  class="form-control btn btn-success text white"><br><br> 
                        </form>
                    </div>
                </div>
