                        ...
                        <form name="form-sancion" method="post" action="procesa_sancion">
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                  <label>Codigo:</label>
                                  <input type="text" class="form-control" value="<%=Cod_Sancion%>" name="Cod_Sancion" readonly>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-10 mb-3">
                                  <label>Lector</label>
                                  <input type="text" name="CodLector" class="form-control" value="<%=CodLector%>" readonly>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label>Tipo de Sancion:</label>
                                    <input type="text" value="<%=Cod_Sanc%>" class="form-control" name="Cod_Sanc" readonly>
                                </div> 
                                <div class="col-md-6 mb-3">
                                    <label>Encargado:</label>
                                    <input type="text" value="<%=CodEncargado%>" class="form-control" name="CodEncargado" readonly>
                                </div>
                            </div><br>
                            <input type="submit" name="eliminar_sancion" value="Ingresar"  class="form-control btn btn-success text white"><br><br> 
                        </form>
                    </div>
                </div>
