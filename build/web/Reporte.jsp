...
<html>
    ...
    <span style="margin-left: 90%">
            <%if(autentica.Logeado.substring(0,2).equals("EN")){%><a class="boton btn btn-danger btn-sm" method="post" href="menuen.jsp">Atras</a>
            <%}if(autentica.Logeado.substring(0,2).equals("BI")){%><a class="boton btn btn-danger btn-sm" method="post" href="menubi.jsp">Atras</a>
                <%}%>
                <div class="row-title">
            ...
            <div class="col-sm-4">
                        <a href="Reporte_lista.jsp">
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-title">
                                        <img class="cliente" src="imagenes/Reportes.png" width="55%">
                                    </div>
                                    <label>Lista</label>
                                </div>
                            </div>
