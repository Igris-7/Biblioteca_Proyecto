...
<html>
    <head>
        ...
        <%
            ...
            Material_B b = new Material_B();
            LinkedList<Material_B> listaMaterial;
            listaMaterial = b.listaMaterial();
            String CodMate_biblio=request.getParameter("CodMate_biblio"),
             ...
             for(int i=0;i<listaMaterial.size();i++){
                 if(listaMaterial.get(i).getCodMate_biblio().equals(CodMate_biblio)){
                     
                    CodEsta_mate=listaMaterial.get(i).getCodEsta_mate(); 
                    AutMate_biblio=listaMaterial.get(i).getAutMate();
                    EditMate_biblio=listaMaterial.get(i).getEditMate();
                    EdiMate_biblio=listaMaterial.get(i).getEdiMate();
                    NomMate_biblio=listaMaterial.get(i).getNomMate_biblio();
                    FePMate_biblio=listaMaterial.get(i).getFePMate();
                 }
             }
        %>
    </head>
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="col-sm-4 mb-2">
                                        <label>Codigo:</label>
                                        <input type="text" class="form-control" placeholder="MB#####" value="<%=CodMate_biblio%>" name="CodMate_biblio" required>
                                    </div>
                                </div>
                                <div class="form-row">
