                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="col-sm-4 mb-2">
                                        <label>Codigo:</label>
                                        <input type="text" class="form-control" value="<%=CodBiblio%>" name="CodBiblio" readonly>
                                    </div>
                                </div>
                                <div class="form-row">
                                   <div class="col-md-7 mb-3">
                                     <label>Nombre:</label>
                                     <input type="text" class="form-control" value="<%=NomBiblio%>" name="NomBiblio" readonly>
                                   </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-7 mb-3">
                                        <label>Apellido:</label>
                                        <input type="text" class="form-control" value="<%=ApeBiblio%>" name="ApeBiblio" readonly>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-3 mb-3">
                                        <label>DNI:</label>
                                        <input type="text" class="form-control" value="<%=DniBiblio%>" name="DniBiblio" readonly>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label>Telefono:</label>
                                        <input type="text" class="form-control" value="<%=TelBiblio%>" name='TelBiblio'  readonly>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        <label>Fecha de Nacimiento:</label>
                                        <input type="date" class="form-control" value="<%=FecBiblio%>" name='FecBiblio' readonly>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label>Direccion:</label>
                                        <input type="text" class="form-control" value="<%=DirBiblio%>" name='DirBiblio' readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer">
                                <input type="submit" name="eliminar_bibliotecario" value="Eliminar"  class="form-control btn btn-success text white">
                            </div>
                        </form>
                    </div>
