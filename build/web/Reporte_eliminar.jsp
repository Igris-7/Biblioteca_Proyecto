    ...
    <head>
        ...
        <div class="row">
            <div class="col text-center">
                    <h1 class="text-white display-4">Eliminacion de Reporte</h1>
            </div>
                   ...
                   <div class="card text-white">
                       <form name="form-reporte" method="post" action="procesa_reporte">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                   <div class="col-md-7 mb-3">
                                     <label>Lector:</label>
                                     <input type="text" class="form-control" value="<%=CodLector%>" name="CodLector" readonly>
                                   </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-7 mb-3">
                            ...
                            <div class="card-footer">
                                <input type="submit" name="eliminar_reporte" value="Registrar"  class="form-control btn btn-success text white">
                            </div>
                        </form>
                    </div>
